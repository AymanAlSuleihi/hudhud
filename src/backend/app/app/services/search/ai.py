    ...
    async def generate_answer_with_chunks_streaming(
        ...
        try:
            ...
            if input_tokens > 0 or output_tokens > 0:
                ...
                logging.warning("[generate_answer_with_chunks_streaming] No token usage data available")
    ...
    async def generate_answer_with_epigraphs_streaming(
        ...
        try:
            ...
            if input_tokens > 0 or output_tokens > 0:
                ...
                logging.warning("[generate_answer_with_epigraphs_streaming] No token usage data available")
