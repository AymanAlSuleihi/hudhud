...
export const Navbar: React.FC = () => {
  ...
  return(
    <>
      <div className="bg-gray-200 text-red-800 text-sm text-center py-1">
          Development in progress - Some features may not work as expected.
          For any queries or suggestions you can reach me at {" "}
          <a href="mailto:contact@shebascaravan.com" className="font-semibold text-gray-500">contact@shebascaravan.com</a>
      </div>
      <nav className="flex justify-center gap-2 p-4 my-4">
        <div className="my-4">
          <svg
        ...
        <div className="flex gap-4 items-center">
          ...
          <Link to="/epigraphs" className="hover:underline">Epigraphs</Link>
        </div>
      </nav>
    </>
  )
